...
This repo contains the Jupyter notebook + program files from my training for O'Reilly from May 2024.  It'll remain open, so you can review the material later on.
